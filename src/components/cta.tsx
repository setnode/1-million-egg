            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="mt-9 flex flex-col items-center gap-4">
                <ConnectButton.Custom>
                  {({ openConnectModal }) => (
                    <Button onClick={openConnectModal} className="h-13 rounded-full bg-primary px-8 text-base text-primary-foreground shadow-premium-lg transition-transform hover:scale-[1.02]">
